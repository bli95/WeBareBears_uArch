...
add wave -noupdate /mainpc_tb/WeBareBears/main_cpu/pl_datpath/pcmux/sel
add wave -noupdate -radix hexadecimal /mainpc_tb/WeBareBears/main_cpu/pl_datpath/pcmux/a
add wave -noupdate -radix hexadecimal /mainpc_tb/WeBareBears/main_cpu/pl_datpath/pcmux/b
add wave -noupdate -radix hexadecimal /mainpc_tb/WeBareBears/main_cpu/pl_datpath/pcmux/c
add wave -noupdate -radix hexadecimal /mainpc_tb/WeBareBears/main_cpu/pl_datpath/pcmux/d
add wave -noupdate -radix hexadecimal /mainpc_tb/WeBareBears/main_cpu/pl_datpath/pcmux/z
add wave -noupdate -radix hexadecimal /mainpc_tb/WeBareBears/main_cpu/pl_datpath/pc/in
add wave -noupdate -radix hexadecimal /mainpc_tb/WeBareBears/main_cpu/pl_datpath/pc/data
